...
class PrintersTest < ApplicationSystemTestCase
  ...
  test "creating a Printer" do
    ...
    fill_in "Assignment", with: @printer.assignment
    fill_in "Brand", with: @printer.brand
    fill_in "Consumable", with: @printer.consumable_id
    fill_in "Model", with: @printer.model
    fill_in "Observations", with: @printer.observations
    fill_in "Quantity", with: @printer.quantity
    fill_in "Sku", with: @printer.sku
    fill_in "Status", with: @printer.status
    fill_in "Value", with: @printer.value
