...
class ConsumablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consumable" do
    assert_difference('Consumable.count') do
      post consumables_url, params: { consumable: { brand: @consumable.brand, model: @consumable.model, quantity: @consumable.quantity, type: @consumable.type, value: @consumable.value } }
    end
  ...
  test "should update consumable" do
    patch consumable_url(@consumable), params: { consumable: { brand: @consumable.brand, model: @consumable.model, quantity: @consumable.quantity, type: @consumable.type, value: @consumable.value } }
